...
public class jira {
		...
		public static void main(String[] args) throws InterruptedException, AWTException {
			String ar[] = {"Hema Malini", "shiva", "Eswaran", "subash"};
		...
		//	assertTrue(notfication.isDisplayed(), "Ticket is not created/ notification not arrived");
			...
			driver.findElement(By.id("childIssuesPanel")).sendKeys("sub task");
			Thread.sleep(4000);
			driver.findElement(By.xpath("(//span[text()='Create'])[2]")).click();
			Thread.sleep(4000);
			...
			wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//h1[text()='task']"))));
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//div[contains(@class,'ua-chrome ProseMirror')]//p[1]")).sendKeys("This is subtask");
			...
			driver.findElement(By.xpath("//p[contains(.,'Type @ to mention and notify someone.')]")).sendKeys("comment");
			driver.findElement(By.xpath("//span[text()='Save']")).click();
			
			wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//span[text()='shilviya']/following::p[text()='comment']"))));
